...
<div style="overflow: hidden;">
  <div class="figure" style="float: left; margin: 0 1.5em 1em 0;">
...
**Electrochemical Quartz Crystal Microbalance with Dissipation (EQCM-D)** provides simultaneous measurements of mass and viscoelastic changes at electrode surfaces, giving us a nanoscale view of how interphases grow, dissolve, and respond to cycling.

**Self-driving laboratories** integrate automated electrochemical testing with machine learning to accelerate electrolyte discovery. By closing the loop between formulation, measurement, and prediction, we aim to navigate large compositional spaces far more efficiently than traditional one-at-a-time experimentation.